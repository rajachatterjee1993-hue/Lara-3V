...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "bYJ1mB5B#HKmws2sMIATJfbL_4KTXgKG90N2j2UidtyH1T-OgMz8", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "9330638789",

...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "XA4ETCgD#AhQg4IMk1JADxQi4xiktLo18GlB-Arl0i3xFgkz_sd8", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "8777602814",
DEV: process.env.DEV || "8777602814",
